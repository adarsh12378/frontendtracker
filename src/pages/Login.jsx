...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status) {  //status code 200 or a custom success flag
                navigate("/")  //if the login crendential is true then it navigate to the home page 
            }
        } catch (error) {
            // console.error(error)
...
//this is the demo code that i write during the coding phase of the project that this way we can also implemented the functionality of the login
